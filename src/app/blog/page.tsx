...
export const metadata: Metadata = { title: "Synthetic Market Research Basics | SMR", description: "Clear explanations of customer research, AI testing and the ideas behind synthetic market research tools.", alternates: { canonical: "/blog" } };
