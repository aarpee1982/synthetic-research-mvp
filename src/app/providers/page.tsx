...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  return { title: `Synthetic Market Research Companies${page > 1 && !filtered ? ` | Page ${page}` : ""} | SMR`, description: "Explore synthetic market research companies, audience simulation tools, digital twins and specialist research services.", alternates: {canonical: filtered ? "/providers" : queryHref("/providers", {}, page)}, robots: filtered ? {index: false, follow: true} : undefined };
}
